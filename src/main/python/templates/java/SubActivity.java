...
public class ${ClassName} extends SubActivity implements Serializable
{
	...
	static
	{
		Implementation.getInstance (SubActivity.class, ${ClassName}.class, ${ClassName}::new);
	...
	public boolean equals (final Object obj)
	{
		...
		else if (obj instanceof ${ClassName})
		{
			...
			ebuilder.append (this.parent, ((${ClassName}) obj).getParent ());
