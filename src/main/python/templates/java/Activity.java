...
public class ${ClassName} extends NamedActivity implements Serializable
{
	...
	static
	{
		Profile.registerCreator (Implementation.getInstance (NamedActivity.metadata, ${ClassName}.class, ${ClassName}::new));
	...
	public boolean equals (final Object obj)
	{
		...
		else if (obj instanceof ${ClassName})
		{
			...
			ebuilder.append (this.type, ((${ClassName}) obj).getType ());
			ebuilder.append (this.course, ((${ClassName}) obj).getCourse ());
			ebuilder.append (this.name, ((${ClassName}) obj).getName ());
