...
public class Scheduler extends NamedActivity implements Serializable
{
	/** Serial version id, required by the Serializable interface */
	private static final long serialVersionUID = 1L;

	/** The primary key for the <code>Scheduler</code> */
	private Long id;
	...
	static
	{
		Profile.registerCreator (Implementation.getInstance (NamedActivity.metadata, Scheduler.class, Scheduler::new));
	...
	public boolean equals (final Object obj)
	{
		...
		else if (obj instanceof Scheduler)
		{
			...
			ebuilder.append (this.type, ((Scheduler) obj).getType ());
			ebuilder.append (this.course, ((Scheduler) obj).getCourse ());
			ebuilder.append (this.name, ((Scheduler) obj).getName ());
