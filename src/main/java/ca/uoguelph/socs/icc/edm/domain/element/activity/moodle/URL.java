...
public class URL extends NamedActivity implements Serializable
{
	/** Serial version id, required by the Serializable interface */
	private static final long serialVersionUID = 1L;

	/** The primary key for the <code>URL</code> */
	private Long id;
	...
	static
	{
		Profile.registerCreator (Implementation.getInstance (NamedActivity.metadata, URL.class, URL::new));
	...
	public boolean equals (final Object obj)
	{
		...
		else if (obj instanceof URL)
		{
			...
			ebuilder.append (this.type, ((URL) obj).getType ());
			ebuilder.append (this.course, ((URL) obj).getCourse ());
			ebuilder.append (this.name, ((URL) obj).getName ());
