...
public class Choice extends GenericNamedActivity
{
	...
	private static final class Factory extends GenericNamedActivity.Factory
	{
		...
		public Activity create (final Activity instance, final String name)
		{
			...
			return new Choice (instance, name);
		}
	}
	...
	static
	{
		GenericNamedActivity.registerActivity (Choice.class, DefaultNamedActivityBuilder.class, new Factory (), "moodle", "Choice");
	}
	...
	public Choice (final Activity instance, final String name)
	{
		super (instance, name);
	}
}
