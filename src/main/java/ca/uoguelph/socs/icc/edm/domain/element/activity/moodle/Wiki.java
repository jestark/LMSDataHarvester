...
public class Wiki extends NamedActivity implements Serializable
{
	/** Serial version id, required by the Serializable interface */
	private static final long serialVersionUID = 1L;

	/** The primary key for the <code>Wiki</code> */
	private Long id;
	...
	/**
	 * Register the <code>Wiki</code> with the factories on
	 * initialization.
	 */

	static
	{
		Implementation.getInstance (NamedActivity.class, Wiki.class, Wiki::new);
		Activity.registerImplementation ("moodle", "wiki", Wiki.class);
	}
