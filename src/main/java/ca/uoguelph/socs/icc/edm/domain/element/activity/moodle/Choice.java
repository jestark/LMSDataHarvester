...
public class Choice extends NamedActivity implements Serializable
{
	/** Serial version id, required by the Serializable interface */
	private static final long serialVersionUID = 1L;

	/** The primary key for the <code>Choice</code> */
	private Long id;
	...
	/**
	 * Register the <code>Choice</code> with the factories on
	 * initialization.
	 */

	static
	{
		Profile.registerCreator (Implementation.getInstance (NamedActivity.metadata, Choice.class, Choice::new));
	...
	public boolean equals (final Object obj)
	{
		...
		else if (obj instanceof Choice)
		{
			...
			ebuilder.append (this.type, ((Choice) obj).getType ());
			ebuilder.append (this.course, ((Choice) obj).getCourse ());
			ebuilder.append (this.name, ((Choice) obj).getName ());
