...
public class Lesson extends NamedActivity implements Serializable
{
	...
	static
	{
		Profile.registerCreator (Implementation.getInstance (NamedActivity.metadata, Lesson.class, Lesson::new));
	...
	public boolean equals (final Object obj)
	{
		...
		else if (obj instanceof Lesson)
		{
			...
			ebuilder.append (this.type, ((Lesson) obj).getType ());
			ebuilder.append (this.course, ((Lesson) obj).getCourse ());
			ebuilder.append (this.name, ((Lesson) obj).getName ());
