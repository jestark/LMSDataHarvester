...
{
	/**
	 * <code>Builder</code> for <code>ForumDiscussionLog</code>.
	 *
	 * @author  James E. Stark
	 * @version 1.0
	...
	public static final class Builder extends LogReference.Builder
	{
		...
		/**
		 * Create an instance of the <code>ForumDiscussionLog</code>.
		 *
		...
		protected LogReference create (final @Nullable LogReference reference)
		{
			...
			return new ForumDiscussionLog (this);
		}
	}
	...
	protected ForumDiscussionLog (final Builder builder)
	{
		super (builder);
