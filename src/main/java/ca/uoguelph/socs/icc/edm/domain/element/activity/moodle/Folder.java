...
public class Folder extends NamedActivity implements Serializable
{
	/** Serial version id, required by the Serializable interface */
	private static final long serialVersionUID = 1L;

	/** The primary key for the <code>Folder</code> */
	private Long id;
	...
	/**
	 * Register the <code>Folder</code> with the factories on
	 * initialization.
	 */

	static
	{
		Profile.registerCreator (Implementation.getInstance (NamedActivity.metadata, Folder.class, Folder::new));
	...
	public boolean equals (final Object obj)
	{
		...
		else if (obj instanceof Folder)
		{
			...
			ebuilder.append (this.type, ((Folder) obj).getType ());
			ebuilder.append (this.course, ((Folder) obj).getCourse ());
			ebuilder.append (this.name, ((Folder) obj).getName ());
