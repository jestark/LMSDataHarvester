...
public class Checklist extends NamedActivity implements Serializable
{
	/** Serial version id, required by the Serializable interface */
	private static final long serialVersionUID = 1L;

	/** The primary key for the <code>Checklist</code> */
	private Long id;
	...
	/**
	 * Register the <code>Checklist</code> with the factories on
	 * initialization.
	 */

	static
	{
		Profile.registerCreator (Implementation.getInstance (NamedActivity.metadata, Checklist.class, Checklist::new));
