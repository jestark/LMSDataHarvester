 ...
 * class, along with the semester converter, converts the start date of the
 ...
 * JPA requires conversionmethods to be implemented in both directions so the
 * conversion of a year to a date will always be January 1 of the year of
 * offering.
 *
 * @see ca.uoguelph.socs.icc.edm.datastore.moodledb.SemesterConverter
...
public class DateYearConverter implements AttributeConverter<Integer, Long>
{
	 ...
	 *
	 * @param year An integer representation of the year of offering.
	 ...
	 * of offering.
	 *
	 * @param seconds Date in seconds since epoch.
