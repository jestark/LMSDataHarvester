...
public class Assign extends NamedActivity implements Serializable
{
	/** Serial version id, required by the Serializable interface */
	private static final long serialVersionUID = 1L;

	/** The primary key for the <code>Assign</code> */
	private Long id;
	...
	/**
	 * Register the <code>Assign</code> with the factories on
	 * initialization.
	 */

	static
	{
		Profile.registerCreator (Implementation.getInstance (NamedActivity.metadata, Assign.class, Assign::new));
	...
	public boolean equals (final Object obj)
	{
		...
		else if (obj instanceof Assign)
		{
			...
			ebuilder.append (this.type, ((Assign) obj).getType ());
			ebuilder.append (this.course, ((Assign) obj).getCourse ());
			ebuilder.append (this.name, ((Assign) obj).getName ());
