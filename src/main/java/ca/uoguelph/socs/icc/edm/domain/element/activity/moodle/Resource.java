...
public class Resource extends NamedActivity implements Serializable
{
	/** Serial version id, required by the Serializable interface */
	private static final long serialVersionUID = 1L;

	/** The primary key for the <code>Resource</code> */
	private Long id;
	...
	public boolean equals (final Object obj)
	{
		...
		else if (obj instanceof Resource)
		{
			...
			ebuilder.append (this.type, ((Resource) obj).getType ());
			ebuilder.append (this.course, ((Resource) obj).getCourse ());
			ebuilder.append (this.name, ((Resource) obj).getName ());
