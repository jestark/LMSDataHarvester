...
public class Quiz extends GenericNamedActivity
{
	...
	static
	{
		GenericNamedActivity.registerActivity (Quiz.class, DefaultNamedActivityBuilder.class, new Factory (), "moodle", "Quiz");
	}
	...
	public Quiz (final Activity instance, final String name)
	{
		super (instance, name);
	}
	 ...
	 * to separate the instances of <code>Quiz</code> from the other
