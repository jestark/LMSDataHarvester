...
public class LessonPage extends GenericGroupedActivityMember
{
	...
	private static final class Factory implements ActivityGroupMemberElementFactory
	{
		...
		public ActivityGroupMember create (ActivityGroup parent, String name)
		{
			...
			{
				throw new IllegalArgumentException ("Parent is not an instance of Lesson");
			}
	...
	static
	{
		GenericGroupedActivityMember.registerActivity (LessonPage.class, Lesson.class, DefaultActivityGroupMemberBuilder.class, new Factory ());
	}
	...
	public LessonPage (ActivityGroup parent, String name)
	{
		super (parent, name);
	}
