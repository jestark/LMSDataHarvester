...
public class LessonPage extends GenericGroupedActivityMember
{
	...
	private static final class Factory extends AbstractActivity.Factory implements SubActivityElementFactory
	{
		...
		{
			assert activity instanceof Lesson : "activity is not an instance of Lesson";
			assert name != null : "name is NULL";

			return new LessonPage (activity, name);
		}
	}
	...
	static
	{
		GenericGroupedActivityMember.registerActivity (LessonPage.class, Lesson.class, DefaultSubActivityBuilder.class, SubActivityElementFactory.class, new Factory ());
	}
