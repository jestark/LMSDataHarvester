...
public class Resource extends GenericNamedActivity
{
	...
	private static final class Factory extends ActivityInstance.Factory implements NamedActivityElementFactory
	{
		...
		public Activity create (final ActivityType type, final Course course, final Boolean stealth, final String name)
		{
			...
			return new Resource (type, course, stealth, name);
		}
	}
	...
	static
	{
		GenericNamedActivity.registerActivity (Resource.class, DefaultNamedActivityBuilder.class, NamedActivityElementFactory.class, new Factory (), "moodle", "Resource");
	}
	...
	public Resource (final ActivityType type, final Course course, final Boolean stealth, final String name)
	{
