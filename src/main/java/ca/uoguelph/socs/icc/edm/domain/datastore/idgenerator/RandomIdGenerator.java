...
public class RandomIdGenerator implements IdGenerator
{
	...
	/**
	 * Create a new <code>RandomIdGenerator</code>, with a set of previously used 
	 * Ids.  
	 *
	 * @param  usedids A <code>Set</code> of all of the used ID numbers, not null
	 */
	...
	/**
	 * Return the <code>Set</code> of previously used ID numbers.  Includes all of
	 * ID numbers generated by this instance of the <code>IdGenerator</code>, and
	 * previous instances.
	 *
