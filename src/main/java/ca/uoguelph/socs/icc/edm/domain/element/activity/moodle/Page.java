...
public class Page extends NamedActivity implements Serializable
{
	...
	static
	{
		Profile.registerCreator (Implementation.getInstance (NamedActivity.metadata, Page.class, Page::new));
	...
	public boolean equals (final Object obj)
	{
		...
		else if (obj instanceof Page)
		{
			...
			ebuilder.append (this.type, ((Page) obj).getType ());
			ebuilder.append (this.course, ((Page) obj).getCourse ());
			ebuilder.append (this.name, ((Page) obj).getName ());
