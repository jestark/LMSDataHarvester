...
public class Workshop extends NamedActivity implements Serializable
{
	/** Serial version id, required by the Serializable interface */
	private static final long serialVersionUID = 1L;

	/** The primary key for the <code>Workshop</code> */
	private Long id;
	...
	static
	{
		Profile.registerCreator (Implementation.getInstance (NamedActivity.metadata, Workshop.class, Workshop::new));
	...
	public boolean equals (final Object obj)
	{
		...
		else if (obj instanceof Workshop)
		{
			...
			ebuilder.append (this.type, ((Workshop) obj).getType ());
			ebuilder.append (this.course, ((Workshop) obj).getCourse ());
			ebuilder.append (this.name, ((Workshop) obj).getName ());
