...
public class Page extends GenericNamedActivity
{
	...
	static
	{
		GenericNamedActivity.registerActivity (Page.class, DefaultNamedActivityBuilder.class, new Factory (), "moodle", "Page");
	}
	...
	public Page (final Activity instance, final String name)
	{
		super (instance, name);
	}
	 ...
	 * to separate the instances of <code>Page</code> from the other
