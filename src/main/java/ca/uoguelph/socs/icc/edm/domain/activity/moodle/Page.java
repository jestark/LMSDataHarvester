...
public class Page extends GenericNamedActivity
{
	 ...
	 * builders to create instances of <code>Page</code>.
	 */
	...
	private static final class Factory extends ActivityInstance.Factory implements NamedActivityElementFactory
	{
		...
		public Activity create (final ActivityType type, final Course course, final Boolean stealth, final String name)
		{
			...
			return new Page (type, course, stealth, name);
		}
	}
	...
	/**
	 * Register the <code>Page</code> with the factories on initialization.
	 */

	static
	{
		GenericNamedActivity.registerActivity (Page.class, DefaultNamedActivityBuilder.class, NamedActivityElementFactory.class, new Factory (), "moodle", "Page");
	}
	...
	public Page (final ActivityType type, final Course course, final Boolean stealth, final String name)
	{
