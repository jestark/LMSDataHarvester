...
public class Book extends NamedActivity implements Serializable
{
	...
	static
	{
		Profile.registerCreator (Implementation.getInstance (NamedActivity.metadata, Book.class, Book::new));
	...
	public boolean equals (final Object obj)
	{
		...
		else if (obj instanceof Book)
		{
			...
			ebuilder.append (this.type, ((Book) obj).getType ());
			ebuilder.append (this.course, ((Book) obj).getCourse ());
			ebuilder.append (this.name, ((Book) obj).getName ());
