...
public class Label extends NamedActivity implements Serializable
{
	/** Serial version id, required by the Serializable interface */
	private static final long serialVersionUID = 1L;

	/** The primary key for the <code>Label</code> */
	private Long id;
	...
	static
	{
		DataStore.registerElement (NamedActivity.metadata, Label.class, Label::new);
	...
	public boolean equals (final Object obj)
	{
		...
		else if (obj instanceof Label)
		{
			...
			ebuilder.append (this.type, ((Label) obj).getType ());
			ebuilder.append (this.course, ((Label) obj).getCourse ());
			ebuilder.append (this.name, ((Label) obj).getName ());
