...
public class MoodleActivityType extends ActivityType implements Serializable
{
	...
	public boolean equals (final Object obj)
	{
		...
		else if (obj instanceof ActivityType)
		{
			...
			ebuilder.append (MoodleActivityType.source, ((ActivityType) obj).getSource ());
	...
	public int hashCode ()
	{
		...
		hbuilder.append (MoodleActivityType.source);
	...
	public String toString ()
	{
		...
		builder.append ("source", MoodleActivityType.source);
