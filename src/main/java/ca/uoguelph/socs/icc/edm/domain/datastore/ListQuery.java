...
/**
 * Retrieve a <code>List</code> of <code>Element</code> instances from the
 * <code>Datastore</code>.  This interface defines the query method for
 * retrieving a <code>List</code> of <code>Element</code> instances from the
 * <code>DataStore</code>.
 *
...
public interface ListQuery<T extends Element> extends Query<T>
{
	/**
	 ...
	 *                                  <code>Element</code> instances which
	 *                                  match the specified query.  The
	 *                                  <code>List</code> will be empty if no
	 *                                  <code>Element</code> instances match
	 *                                  the <code>Query</code>.
	...
	public abstract List<T> query (Map<String, Object> parameters);
}
