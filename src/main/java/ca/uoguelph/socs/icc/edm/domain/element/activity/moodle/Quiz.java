...
public class Quiz extends NamedActivity implements Serializable
{
	/** Serial version id, required by the Serializable interface */
	private static final long serialVersionUID = 1L;

	/** The primary key for the <code>Quiz</code> */
	private Long id;
	...
	/**
	 * Register the <code>Quiz</code> with the factories on
	 * initialization.
	 */

	static
	{
		Profile.registerCreator (Implementation.getInstance (NamedActivity.metadata, Quiz.class, Quiz::new));
	...
	public boolean equals (final Object obj)
	{
		...
		else if (obj instanceof Quiz)
		{
			...
			ebuilder.append (this.type, ((Quiz) obj).getType ());
			ebuilder.append (this.course, ((Quiz) obj).getCourse ());
			ebuilder.append (this.name, ((Quiz) obj).getName ());
