...
public class ForumPost extends SubActivity implements Serializable
{
	...
	static
	{
		Profile.registerCreator (Implementation.getInstance (SubActivity.metadata, ForumPost.class, ForumPost::new));
		Activity.registerImplementation (ForumDiscussion.class, ForumPost.class);
	}
