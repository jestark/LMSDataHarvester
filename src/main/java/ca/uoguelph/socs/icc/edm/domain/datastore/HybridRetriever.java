...
public final class HybridRetriever<T extends Element> implements Retriever<T>
{
	/** The Log */
	...
	/**
	 * Create the <code>HybridRetriever</code>.
	 *
	...
	protected HybridRetriever (final DomainModel model, final Query<T> query, final TranslationTable table)
	{
