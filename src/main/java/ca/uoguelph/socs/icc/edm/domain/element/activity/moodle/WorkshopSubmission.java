...
public class WorkshopSubmission extends SubActivity implements Serializable
{
	...
	static
	{
		DataStore.registerElement (SubActivity.metadata, WorkshopSubmission.class, WorkshopSubmission::new);
		Activity.registerImplementation (WorkshopSubmission.class, Workshop.class);
	}
