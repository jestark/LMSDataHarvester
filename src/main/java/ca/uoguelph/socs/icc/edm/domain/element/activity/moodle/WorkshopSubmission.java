...
public class WorkshopSubmission extends SubActivity implements Serializable
{
	/** Serial version id, required by the Serializable interface */
	private static final long serialVersionUID = 1L;

	/** The primary key for the <code>WorkshopSubmission</code> */
	private Long id;
	...
	static
	{
		Profile.registerCreator (Implementation.getInstance (SubActivity.metadata, WorkshopSubmission.class, WorkshopSubmission::new));
		Activity.registerImplementation (Workshop.class, WorkshopSubmission.class);
	}
	...
	public boolean equals (final Object obj)
	{
		...
		else if (obj instanceof WorkshopSubmission)
		{
			EqualsBuilder ebuilder = new EqualsBuilder ();
			ebuilder.append (this.name, ((WorkshopSubmission) obj).getName ());
			ebuilder.append (this.parent, ((WorkshopSubmission) obj).getParent ());
