...
public class WorkshopSubmission extends SubActivity
{
	/**
	 * <code>Builder</code> for <code>WorkshopSubmission</code>.
	 *
	 * @author  James E. Stark
	 * @version 1.0
	...
	public static final class Builder extends SubActivity.Builder
	{
		...
		/**
		 * Create an instance of the <code>WorkshopSubmission</code>.
		 *
		...
		protected SubActivity create (final @Nullable SubActivity subActivity)
		{
			...
			return new WorkshopSubmission (this);
		}
	}
