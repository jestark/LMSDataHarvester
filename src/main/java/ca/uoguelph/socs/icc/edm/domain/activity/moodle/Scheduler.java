...
public class Scheduler extends GenericNamedActivity
{
	...
	private static final class Factory extends GenericNamedActivity.Factory
	{
		...
		public Activity create (final Activity instance, final String name)
		{
			...
			return new Scheduler (instance, name);
		}
	}
	...
	static
	{
		GenericNamedActivity.registerActivity (Scheduler.class, DefaultNamedActivityBuilder.class, new Factory (), "moodle", "Scheduler");
	}
	...
	public Scheduler (final Activity instance, final String name)
	{
		super (instance, name);
	}
	 ...
	 * to separate the instances of <code>Scheduler</code> from the other
