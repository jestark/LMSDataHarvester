...
public class Feedback extends NamedActivity implements Serializable
{
	...
	static
	{
		Profile.registerCreator (Implementation.getInstance (NamedActivity.metadata, Feedback.class, Feedback::new));
	...
	public boolean equals (final Object obj)
	{
		...
		else if (obj instanceof Feedback)
		{
			...
			ebuilder.append (this.type, ((Feedback) obj).getType ());
			ebuilder.append (this.course, ((Feedback) obj).getCourse ());
			ebuilder.append (this.name, ((Feedback) obj).getName ());
