...
public class Feedback extends GenericNamedActivity
{
	...
	static
	{
		GenericNamedActivity.registerActivity (Feedback.class, DefaultNamedActivityBuilder.class, new Factory (), "moodle", "Feedback");
	}
	 ...
	 * to separate the instances of <code>Feedback</code> from the other
