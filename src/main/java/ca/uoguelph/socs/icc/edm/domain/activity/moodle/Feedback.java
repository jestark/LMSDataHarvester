...
public class Feedback extends GenericNamedActivity
{
	...
	private static final class Factory extends ActivityInstance.Factory implements NamedActivityElementFactory
	{
		...
		public Activity create (final ActivityType type, final Course course, final Boolean stealth, final String name)
		{
			...
			return new Feedback (type, course, stealth, name);
		}
	}
	...
	/**
	 * Register the <code>Feedback</code> with the factories on initialization.
	 */

	static
	{
		GenericNamedActivity.registerActivity (Feedback.class, DefaultNamedActivityBuilder.class, NamedActivityElementFactory.class, new Factory (), "moodle", "Feedback");
	}
	...
	public Feedback (final ActivityType type, final Course course, final Boolean stealth, final String name)
	{
