...
public class Label extends GenericNamedActivity
{
	...
	private static final class Factory extends GenericNamedActivity.Factory
	{
		...
		public Activity create (final Activity instance, final String name)
		{
			...
			return new Label (instance, name);
		}
	}
	...
	static
	{
		GenericNamedActivity.registerActivity (Label.class, DefaultNamedActivityBuilder.class, new Factory (), "moodle", "Label");
	}
	...
	public Label (final Activity instance, final String name)
	{
		super (instance, name);
	}
	 ...
	 * to separate the instances of <code>Label</code> from the other
