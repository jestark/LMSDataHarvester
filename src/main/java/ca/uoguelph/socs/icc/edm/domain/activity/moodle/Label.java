...
public class Label extends GenericNamedActivity
{
	/**
	 * Implementation of the <code>NamedActivityElementFactory</code>.  Allows the
	 * builders to create instances of <code>Label</code>.
	 */
	...
	private static final class Factory extends ActivityInstance.Factory implements NamedActivityElementFactory
	{
		...
		public Activity create (final ActivityType type, final Course course, final Boolean stealth, final String name)
		{
			...
			return new Label (type, course, stealth, name);
		}
	}
	...
	/**
	 * Register the <code>Label</code> with the factories on initialization.
	 */

	static
	{
		GenericNamedActivity.registerActivity (Label.class, DefaultNamedActivityBuilder.class, NamedActivityElementFactory.class, new Factory (), "moodle", "Label");
	}
	...
	public Label (final ActivityType type, final Course course, final Boolean stealth, final String name)
	{
