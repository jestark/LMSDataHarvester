...
public final class MappedBuilderFactory<T extends Element, X extends ElementBuilder<T>> extends AbstractMappedFactory<Class<? extends X>, X, DomainModel>
{
	private class
	{
	...
	public MappedBuilderFactory (Class<T> type)
	{
		...
		this.log = LogFactory.getLog (MappedBuilderFactory.class);
