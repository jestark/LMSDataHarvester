...
public class BookChapter extends SubActivity implements Serializable
{
	...
	/** The primary key for the <code>BookChapter</code> */
	private Long id;
	...
	static
	{
		Profile.registerCreator (Implementation.getInstance (SubActivity.metadata, BookChapter.class, BookChapter::new));
		Activity.registerImplementation (Book.class, BookChapter.class);
	}
